...
>
> **Snapshot:** 2026-09-20, sau thay đổi gán spot đầu tiên và chọn số Supply thích ứng.
...
### 3.6 Trận tham chiếu `4e30abae-0302-44e8-9381-0356171ebd60`

| Thuộc tính | Giá trị |
|---|---|
| Map | `16 × 17` = 272 ô |
| Terrain | 160 plain, 53 road, 36 mountain, 23 pond |
| Vị trí đầu xe | `261, 110, 124, 199, 12, 43` |
| Tọa độ đầu | `(5,16), (14,6), (12,7), (7,12), (12,0), (11,2)` |
| Fuel limit | `69` |
| Ngày/steps | 5 ngày; `33, 50, 66, 83, 99` |
| Spot/brand | 12 spot, 9 brand |
| Stock/ngày | `23` |
| Tiềm năng toàn trận | `115 servings` |
| Đội hình server ghi nhận | `4 Patrol + 2 Supply` |
| Kết quả người dùng quan sát | `42 servings` |

Team API kết thúc trận chỉ cung cấp state cuối; các endpoint `trace/history/replay`
dưới `/api/game` trả `404`, còn admin replay trả `401`. Không có browser session đã
...
|---:|---|---:|---:|---:|
| 0 | `115, 162, 26, 0, 0` | 303 | 64 | 0 |
| 1 | `93, 140, 97, 110, 74` | 514 | 96 | 6 |
| 2 | `79, 115, 143, 143, 113` | **593** | **102** | 10 |
| 3 | `56, 89, 114, 142, 143` | 544 | 89 | 12 |
| 4 | `38, 58, 76, 94, 112` | 378 | 65 | 9 |
| 5 | `17, 28, 39, 50, 56` | 190 | 34 | 5 |

Do đó adaptive selector chọn 2 Supply cho config này. Chênh lệch `102 offline` so
với `42 server` là bằng chứng rằng tỷ lệ đội hình không giải thích được toàn bộ lỗi.
Các khả năng cần trace để phân biệt: binary chạy trận không cùng snapshot, action bị
...
- Nhờ vậy fuel đủ dùng sẽ chọn 0 Supply; fuel khan hiếm chỉ thêm Supply khi refuel làm
  tổng quãng đường Patrol tăng thật. Luôn giữ ít nhất một Patrol.
- Ceiling có chủ ý: chưa biết traffic/opponent trước trận nên trial không mô phỏng hai
  yếu tố này. Nếu server cung cấp scenario trước trận, thay bằng sampled trials.
- Regression dùng hai fixture: fuel dư chọn 0 Supply; fuel `6` chọn 2/6 Supply với
  distance exhaustive `32, 52, 65, 56, 47, 23`.
...
- Adaptive fleet trial tối ưu distance trước servings theo yêu cầu hiện tại; đây không
  phải cùng objective lexicographic với điểm chính thức của trận.
